    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            catch (Nefarius.ViGEm.Client.Exceptions.VigemBusNotFoundException)
            {
                ...
                if (MessageBox.Show(
                    "WiimoteThing requires the ViGEmBus driver to function.\nClick OK to get it from its releases page.",
                    "ViGEmBus Not Found",
            ...
            Title = "WiimoteThing v" + version.ToString();
        ...
        {
            Process.Start("https://github.com/TheNathannator/WiimoteThing");
        }
        ...
        {
            var dlg = groupXinput.Children.Count == 0 ? MessageBoxResult.Yes : MessageBox.Show("Are you sure you want to close WiimoteThing?\n\nALL connected controllers will STOP WORKING!", "Close WiimoteThing?", MessageBoxButton.YesNo, MessageBoxImage.Question);
