        ...
        public static UserPrefs Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    else if (File.Exists(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\WiimoteThing_prefs.config"))
                    {
                        DataPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\WiimoteThing_prefs.config";
                        LoadPrefs();
                    }
                    else
                    {
